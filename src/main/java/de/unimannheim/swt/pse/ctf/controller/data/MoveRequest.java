...
public class MoveRequest {
  ...
  @Schema(description = "the team secret which is checked if team is allowed to make a move")
  private String teamSecret;

  @Schema(description = "the piece by its unique identifier to move")
  private String pieceId;

  @Schema(description = "the new position of the piece")
