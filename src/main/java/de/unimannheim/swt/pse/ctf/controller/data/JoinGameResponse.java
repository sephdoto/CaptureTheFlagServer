...
public class JoinGameResponse {
  @Schema(description = "join the game with this session identifier")
  private String gameSessionId;

  @Schema(
      description =
          "a secret generated for the team to only allow certain teams to make a move when it's"
              + " their turn (basic anti-cheat)")
  private String teamSecret;

  @Schema(description = "unique team identifier")
  private String teamId;

  @Schema(description = "the unique color set for the team")
